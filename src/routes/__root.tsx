...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ScaleUp — Gestor Financeiro Inteligente" },
      ...
      { property: "og:title", content: "ScaleUp — Gestor Financeiro Inteligente" },
      { name: "twitter:title", content: "ScaleUp — Gestor Financeiro Inteligente" },
