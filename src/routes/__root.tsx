...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "FinanceFlow — Gestor Financeiro Inteligente" },
      { name: "description", content: "Controle de faturamento, fechamento de caixa e análise de taxas em um só lugar." },
      { property: "og:title", content: "FinanceFlow — Gestor Financeiro Inteligente" },
      { name: "twitter:title", content: "FinanceFlow — Gestor Financeiro Inteligente" },
