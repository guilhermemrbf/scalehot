      ...
      <div className="min-h-screen grid place-items-center bg-gradient-hero px-4">
        <Card className="w-full max-w-md p-8 bg-gradient-card">
          <div className="flex flex-col items-center text-center mb-6">
            ...
            <p className="text-sm text-muted-foreground mt-1">vamos transformar todo o painel do cliente transformando ele em um Gateway basicamente onde eu vou ter o controle de tudo pelo meu painel aprovando as vendas Como já era antes então toda a vida que eu colocar como aprovada por exemplo pelo cliente 01 e toda a venda que eu colocar aprovada para o cliente 02 já vai aparecer no sábado de cada painel</p>
          </div>
          <form
